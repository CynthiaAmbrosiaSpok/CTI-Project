...
//			}
	...
	public SoftAssert verifyConnectedCallStatus(SoftAssert softAssert) {
		...
		try {
			...
			reportLoggerMethods.reportFailedCheckpoint("Failed: " + failureMessage, "OzekiPage_verifyConnectedCallStatus");
		}
	...
	public SoftAssert verifyRingingCallStatus(SoftAssert softAssert) {
		...
		try {
			...
			reportLoggerMethods.reportFailedCheckpoint("Failed: " + failureMessage, "OzekiPage_verifyRingingCallStatus");
		}
